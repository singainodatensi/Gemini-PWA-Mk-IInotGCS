# Gemini PWA Client Mk-II (Personal Fork)

> [!NOTE]
> 本プロジェクトは [kinkan04氏のGemini-PWA-Mk-II](https://github.com/kinkan04/Gemini-PWA-Mk-II) をベースに、個人用としてフォーク・カスタマイズしたリポジトリです。本家作者の **ona-oni** 様および **kinkan04** 様に深く感謝いたします。
...
1.  **[こちらにアクセス](https://singainodatensi.github.io/Gemini-PWA-Mk-IInotGCS/)** してPWAを開きます。
...
### GitHub Pages (https://singainodatensi.github.io/Gemini-PWA-Mk-IInotGCS/) から利用する際の注意点
